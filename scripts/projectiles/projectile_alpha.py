...
class ProjectileAlpha(EnemyProjectile):
    """
    TwoAlpha 적 탄환 클래스
    ...
    def __init__(self, start_position: pg.Vector2, start_direction: pg.Vector2):
        super().__init__("two_alpha_projectile", start_position, start_direction, DEFAULT_LIFE_TIME, destroy_on_tilemap_collision=False)
