...
# 착한거!! (안전빵)
SOUL_KIND_A = "착한거 A"   # 빛 안에 있으면 체력 빨리 참 | 이속 감소
SOUL_KIND_B = "착한거 B"   # 안개 좀더 투명해짐 | 플레이어가 주는 대미지 감소
SOUL_KIND_C = "착한거 C"   # 이동속도 증가 | 체력은 좀 낮음 ㅇㅇ;
...
# 나쁜거 !! (risky but cool)
SOUL_EVIL_A = "나쁜거 A"   # 관통 되는 탄환 | 빠른 탄속 | 대신 쿨타임 좀 긺 | 플레이어가 공격했을때 넉백 증가 (적이 갖고 있으면 이속 증가)
SOUL_EVIL_B = "나쁜거 B"   # 쿨타임 엄청 짧아짐 | 체력 떡락                              (적이 갖고 있으면 대미지 증가)
SOUL_EVIL_C = "나쁜거 C"   # 몰라 (적이 갖고 있으면 체력 증가)
...
# 적이 갖고 있으면 바뀌는 만큼의 량
ENEMY_EVIL_A_SPEED_UP = 2
ENEMY_EVIL_B_DAMAGE_UP = 15
